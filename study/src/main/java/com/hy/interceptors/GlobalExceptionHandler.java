package com.hy.interceptors;

import com.fasterxml.jackson.databind.JsonMappingException;
import com.hy.exception.AppWebException;
import com.hy.exception.ErrorConstant;
...
//        return result(HttpStatus.INTERNAL_SERVER_ERROR.value(), ErrorConstant.RUNTIME_EXCEPTION.getMsg(), runtimeException);
